...
export default async function DashboardPage() {
  ...
  const heatmapData = Object.entries(heatmapCounts).map(
    ([due_at, assignment_count]) => ({ due_at, assignment_count }),
  );
      ...
      <main className="flex-1 px-5 py-6 sm:px-6 sm:py-7 max-w-7xl w-full mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
          ...
          <div className="xl:col-span-1 flex flex-col gap-4">
            <div className="rounded-[18px] bg-[#151C2B] border border-[#2A3444] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.2)]">
              <p className="text-[#7E8AA0] text-xs font-semibold uppercase tracking-widest mb-6">
                Overview
              </p>
              ...
              <div className="flex flex-col gap-5">
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-[#1C2637] border border-[#2A3444] flex items-center justify-center shrink-0">
                    <BookOpen size={17} className="text-[#AAB4C4]" />
                  </div>
                  <div>
                    <p className="text-[#F6F1E8] font-bold text-3xl leading-none group-hover:text-[#D6B36A] transition-colors">
                      {totalCount}
                    </p>
                    <p className="text-[#7E8AA0] text-sm mt-1">
                      Total assignments
                    </p>
                  </div>
                </Link>

                <div className="h-px bg-[#2A3444]" />
                ...
                <Link
                  ...
                  className="flex items-start gap-4 group"
                >
                  <div className="w-10 h-10 rounded-xl bg-[#C97064]/10 border border-[#C97064]/20 flex items-center justify-center shrink-0">
                    <AlertTriangle size={17} className="text-[#C97064]" />
                  </div>
                  <div>
                    <p className="text-[#C97064] font-bold text-3xl leading-none">
                      {overdueCount}
                    </p>
                    <p className="text-[#7E8AA0] text-sm mt-1">Overdue</p>
                  </div>
                </Link>
                ...
                {/* Due this week */}
                <Link
                  href="/dashboard/assignments?filter=upcoming"
                  className="flex items-start gap-4 group"
                >
                  <div className="w-10 h-10 rounded-xl bg-[#D6B36A]/10 border border-[#D6B36A]/20 flex items-center justify-center shrink-0">
                    <CalendarClock size={17} className="text-[#D6B36A]" />
                  </div>
                  <div>
                    <p className="text-[#D6B36A] font-bold text-3xl leading-none">
                      {dueThisWeekCount}
                    </p>
                    <p className="text-[#7E8AA0] text-sm mt-1">Due this week</p>
                  </div>
                </Link>
              </div>
            </div>
            ...
            <Link
              ...
              className="rounded-[18px] bg-[#151C2B] border border-[#2A3444] p-5 flex items-center justify-between group hover:border-[#3A4454] transition-colors"
            >
              <div>
                ...
                <p className="text-[#7E8AA0] text-xs mt-0.5">
                  See your productive patterns
                </p>
              </div>
              <span className="text-[#D6B36A] text-lg group-hover:translate-x-1 transition-transform">
                →
              </span>
            </Link>
          </div>
